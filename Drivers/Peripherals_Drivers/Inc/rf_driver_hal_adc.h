...
#endif
{
  ...
  void (* WatchdogAlertCallback)(struct __ADC_HandleTypeDef *hadc);   /*!< ADC analog watchdog callback */
...
/** @defgroup ADC_Event_type ADC Event type
  * @{
  */
#define ADC_EOSMP_EVENT         (ADC_IRQ_FLAG_EOS)    /*!< ADC End of Sampling event */
#define ADC_AWD_EVENT           (ADC_IRQ_FLAG_AWD)    /*!< ADC Analog watchdog event */
#define ADC_OVR_EVENT           (ADC_IRQ_FLAG_OVRDS)  /*!< ADC overrun event */
/**
  * @}
  */
