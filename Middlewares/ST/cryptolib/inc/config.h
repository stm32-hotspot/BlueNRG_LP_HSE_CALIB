...
/** @defgroup CRYPTO_LIBRARY_VERSION
  *  This group is just used by the function STM32_GetCryptoLibrarySettings to get the current library settings
  *  This group has no impact on the algorithms implementation
  * @{
  */
#define VERSION_X 3 /*!< The X parameter of the current STM32 crypto library verion */
#define VERSION_Y 2 /*!< The Y parameter of the current STM32 crypto library verion */
#define VERSION_Z 0 /*!< The Z parameter of the current STM32 crypto library verion */
/**
...
// #define CORTEX_M0_plus            ((uint16_t)0x0002)    /*!< Library is compiled for Cortex M0+ */
...
#if defined(CORTEX_M0) || defined(CORTEX_M0_plus) || defined(CORTEX_M3) || defined(CORTEX_M4) || defined(CORTEX_M7)
/**
  * @defgroup SHA3asmConf Compiler setting
  *  This group is just used to enable the SHA3 assembly optimized code for Cortex-M processors
  * @{
  */
#define USE_SHA3_ASM
/**
...
// #define IAR_Optimization      ((uint16_t)0x0003)    /*!< The compiler optimization is Medium optimization                              */
...
#define INCLUDE_SHA3     ((uint16_t)0x0100) /*!< SHA-3 functions are included in the library                                          */
...
#define INCLUDE_KMAC     ((uint16_t)0x0200) /*!< Select if KMAC based on SHA-3 functions is included in the library, it requires SHA3 */
#endif
...
/**
  * @defgroup DRBG_AES256_Conf Deterministic Random Bit Generator Based on AES-256
  * @{
  */
//#define INCLUDE_DRBG_AES256       ((uint16_t)0x0003)  /*!< Includes the deterministic random bit generator */
/**
  * @}
  */
...
#define USE_HW_AES_XXX
#define USE_AES_128_ONLY
