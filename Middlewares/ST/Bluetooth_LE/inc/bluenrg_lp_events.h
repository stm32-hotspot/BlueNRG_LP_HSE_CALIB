...
/**
 * @brief This event is used to indicate that the Controller's data buffers have
 *        been overflowed. This can occur if the Host has sent more packets than
 *        allowed. The Link_Type parameter is used to indicate that the overflow
 *        was caused by ACL data.
...
/**
 *@addtogroup HAL HAL
 *@brief Hardware Abstraction Layer and Link Layer API
 *@{
 */
/**
 *@defgroup HAL_events HAL Events
 *@brief Events for HAL.
 *@{
 */
/* ACI HAL events */
/**
